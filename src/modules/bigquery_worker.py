...
class BigQueryWorker:
    ...
    def insert_with_client(self, df, schema_dic, full_table_id, time_partition_key=None):
        ...
        table = self.client.get_table(table_ref) if self.table_exists(full_table_id) else None
    ...
    def table_exists(self, full_table_id):
        """テーブルが存在するかどうかを確認するヘルパーメソッド"""
        try:
